...
<html lang="en">
  ...
  <head>
    ...
    <link href="https://fonts.googleapis.com/css?family=Poppins:100,200,300,400,500,600,700,800,900&display=swap" rel="stylesheet">
      ...
      <title>متجر التميز - من نحن</title>
        ...
        <div class="row">
          ...
          <div class="col-md-6">
            <div class="left-content">
              <h4>من نكون وماذا نفعل ؟</h4>
              <p>شركة بدأت بمكتب ومجموعة من الأفراد وكانت انطلاقتها قوية من خلال موقعها على الانترنت واصبح اسم الموقع
                  <br><br>
        متجر التميز من الاسماء المشهورة على المستوى المحلي
        <br><br>
        نثق بكم..ثقو بنا</p>
        ...
        <div class="row">
          <div class="col-md-12">
            <div class="inner-content">
                <p>جميع الحقوق محفوظة &copy; 2021  </p> </div> </div>
          </div>
        </div>
      </div>
    </footer>
