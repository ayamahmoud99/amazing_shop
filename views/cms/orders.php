    ...
    <div class="content-wrapper">
        <section class="content">
            <div class="row">
                ...
                $orders = $orderDb->findAll($search, $page);
        ...
        <td>           
                ' . $order["total"] .  " ليرة سورية" . '               
            </td>  
            <td class="project-actions text-right">
            
              <a class="btn btn-danger btn-sm" data-id="' . $order["id"] . '" data-toggle="modal" data-target="#modal-delete" href="#">
                <i class="fa fa-trash">
                </i>
                حذف
              </a>
              <a class="btn btn-info btn-sm"  href="'.$siteUrl . "cms/orderDetails.php?id=". $order["id"] .' ">
                <i class="fa fa-eye">
                </i>
                عرض
              </a>
                        ...
                        <div class="box-footer clearfix">
                            <ul class="pagination pagination-sm no-margin pull-right">
                                ...
                                echo '<li><a href="' . $siteUrl . 'cms/orders.php?search=' . $search . '&page=' . ($page - 1) . '">«</a></li>';
                                for ($i = $min; $i <= $max; $i++) {
                                    if ($i == $page) {
                                        echo ' <li class="active"><a href="' . $siteUrl . 'cms/orders.php?search=' . $search . '&page=' . $i . '"">' . $i . '</a></li>';
                                    } else {
                                        echo ' <li><a href="' . $siteUrl . 'cms/orders.php?search=' . $search . '&page=' . $i . '">' . $i . '</a></li>';
                                    }
                                }
                                echo '<li><a href="' . $siteUrl . 'cms/orders.php?search=' . $search . '&page=' . ($page + 1) . '">»</a></li>';
                                ?>
    ...
    <div class="modal fade" id="modal-delete">
        <div class="modal-dialog modal-sm">
            <div class="modal-content">
                ...
                <form action="../../controllers/orders.php" method="POST" id="delete-form">
