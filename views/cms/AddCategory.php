                    ...
                    <div class="box box-info">
                        ...
                        <form action="../../controllers/categories.php" method="post" enctype="multipart/form-data"
                            ...
                            <div class="box-body">
                                <div class="row">
                                    <div class="form-group col-sm-6">
                                        <label class="col-sm-4 control-label"> اسم القسم </label>
                                        <div class="col-sm-8">
                                    ...
                                    <div class="form-group col-sm-6">
                                        <label class="col-sm-4 control-label"> وصف القسم </label>
                                        <div class="col-sm-8">
                                    ...
                                    <div class="form-group col-sm-6">
                                        <label class="col-sm-4 control-label"> مفعلة ؟  </label>
                                        <div class="col-sm-8">
                            ...
                            <div class="box-footer">
                                ...
                                <button type="submit" class="btn btn-info pull-right">إضافة</button>
                            </div>
                            <!-- /.box-footer -->
                        </form>
                    </div>
