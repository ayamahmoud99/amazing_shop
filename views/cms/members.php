    ...
    <div class="content-wrapper">
        <section class="content">
            <div class="row">
                ...
                $userDb = new User($db);
                $users = $userDb->findAll($search,$page);

                ?>
                <div class="col-xs-12">
                    <div class="box box-info">
                        <div class="box-header with-border">
                            <h3 class="box-title"> المشتركين </h3>
                            <div class="box-tools">
        ...
        <td>           
            ...
            <td class="project-actions text-right">
              ...
              <a class="btn btn-danger btn-sm" data-id="' . $user["id"] . '" data-toggle="modal" data-target="#modal-delete" href="#">
                <i class="fa fa-trash">
                </i>
                حذف
              </a>
                        ...
                        <div class="box-footer clearfix">
                            <ul class="pagination pagination-sm no-margin pull-right">
                                ...
                                echo '<li><a href="'.$siteUrl . 'cms/members.php?search=' . $search . '&page=' . ($page - 1) .'">«</a></li>';
                                for ($i = $min; $i<= $max ; $i++){
                                        if($i == $page){
                                            echo ' <li class="active"><a href="'.$siteUrl . 'cms/members.php?search=' . $search . '&page=' . $i .'"">'. $i .'</a></li>';
                                        }else{
                                            echo ' <li><a href="'.$siteUrl . 'cms/members.php?search=' . $search . '&page=' . $i .'">'. $i .'</a></li>';
                                        }
                                }
                                echo '<li><a href="'.$siteUrl . 'cms/members.php?search=' . $search . '&page=' . ($page + 1) .'">»</a></li>';
                                ?>
        ...
        <div class="modal-dialog modal-sm">
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <p>   هل أنت متأكد من أنك تريد حذف هذا المشترك , لن يتم حذف المشترك في حال وجود طلبيات متعلقة به</p>
                </div>
                <form action="../../controllers/users.php" method="POST" id="delete-form">
